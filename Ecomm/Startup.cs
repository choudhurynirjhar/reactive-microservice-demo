...
namespace Ecomm
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IInventoryProvider>(new InventoryProvider(Configuration["ConnectionString"]));
            services.AddSingleton<IProductProvider>(new ProductProvider(Configuration["ConnectionString"]));
